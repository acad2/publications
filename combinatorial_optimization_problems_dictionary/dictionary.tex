...
\dey[frequency assignment]{Frequency assignment}{A family of problems related to wireless communication. In all problems a set of \nmns{transmitter} are considered}[minimum order frequency assignment,minimum span frequency assignment,minimum blocking frequency assignment,minimum inference frequency assignment]

%TODO: problems to define
\dey[minimum order frequency assignment]{Minimum order frequency assignment}{}

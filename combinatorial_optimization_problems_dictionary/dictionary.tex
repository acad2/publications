...
\defentry[knapsack]{Knapsack}{The knapsack problem is a group of different problems. In each problem, one is given a sequence of items. Each item has one or more weights and some kind of utility value\footnote{Sometimes this value depends on other objects in the bag.}. The objective is to generate a bag of objects such that the total utility is maximized under one or more weight bounds.}

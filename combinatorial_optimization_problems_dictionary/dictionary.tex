...
\newcommand{\fcopm}{}
\newcommand{\fcop}[3][+]{\ifthenelse{\equal{#1}{+}}{\renewcommand{\fcopm}{maximize}}{\renewcommand{\fcopm}{minimize}}\begin{eqnarray}\mbox{\fcopm{}}&&#2,\\\mbox{subject to}&&#3\end{eqnarray}}

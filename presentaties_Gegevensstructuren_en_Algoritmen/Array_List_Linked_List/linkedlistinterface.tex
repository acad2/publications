...
\strobj{elem1}{Gert}
\end{scope}
\begin{scope}[xshift=6 cm,yshift=1.5 cm]
\strobj{elem2}{Octaaf}
\end{scope}
\begin{scope}[xshift=7 cm]
...
\end{methodexample}
\end{frame}
\begin{frame}[fragile]{\dslinkedlist{} in Java: \texttt{add (int index, E element)}}
...
\strobj{elem2}{Octaaf}
\end{scope}
\begin{scope}[xshift=7 cm,yshift=-1 cm]
\strobj{elem3}{Alberto}
\end{scope}
\begin{scope}[xshift=7 cm]
\tikzlinkedlistptr{2}{namenlist}
\end{scope}
\begin{scope}[xshift=8.5 cm,yshift=-0.75 cm]
...
\end{methodexample}
\end{frame}
\begin{frame}[fragile]{\dslinkedlist{} in Java: \texttt{remove (int index)}}
...
\end{methodexample}
\end{frame}
\begin{frame}[fragile]{\dslinkedlist{} in Java: \texttt{remove (Object o)}}
...
\end{methodexample}
\end{frame}
\begin{frame}[fragile]{\dslinkedlist{}: verschil met \dsarraylist{}}

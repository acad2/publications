...
Een \dsarraylist{} is een klasse in Java die werkt op basis van een array en een teller.
\begin{figure}
\centering
\begin{tikzpicture}
\genobj{alo}{elementen,aantal/3}{}
\begin{scope}[xshift=3 cm,yshift=-1 cm]
\tikzarrayptr{9}{aloarray}
\pointrtlebridge{aloptrelementen}{aloarray.west}
\end{scope}
\begin{scope}[xshift=4.5 cm,yshift=0.5 cm]
\strobj{elem0}{Samson}
\end{scope}
\begin{scope}[xshift=5.5 cm,yshift=-0.25 cm]
\strobj{elem2}{Octaaf}
\end{scope}
\begin{scope}[xshift=2 cm,yshift=-1.5 cm]
\strobj{elem3}{Alberto}
\end{scope}

...
\importtikzfigure{capacitor}{De realisatie van een condensator.}
...
\subsection{Spoelen}
Een spoel tracht de stroomsterkte te behouden, dit doet een spoel door de stroomsterkte om te zetten in een magnetisch veld.

\importtikzfigure{inductor}{De realisatie van een spoel.}

\subsection{Transistoren}
We hebben transistoren al in \chpref{} besproken, maar dan vooral in een digitale context. Transistoren worden echter ook in een analoge context gebruikt: als versterker waarbij de weerstand tussen de collector en de emittor wordt bepaald door de spanning die op de basis wordt aangelegd.
\subsection{Diodes}
\emph{Diodes} en \emph{operationele versterkers} zijn componenten die toelaten om bepaalde drempelwaarden in 
\section{Bouw van een elektronische schakeling}
\subsection{Matrixbord}
Een \emph{matrixbord} ook wel \emph{breadboard} genoemd is .

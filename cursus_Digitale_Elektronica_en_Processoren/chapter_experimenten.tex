...
Wanneer we D-flipflops gebruiken bekomen dienen we combinatorische schakelingen te implementeren zoals op \tblref{infinitemul-combine5} een grafische voorstelling met behulp van Karnaugh-kaarten staat op \figref{infinitemul-karnaugh5}.

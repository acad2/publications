...
% \importtabulartable{ininitemul-state5}{Toestandstabel van de oneindige vermenigvuldiger.}
...
% \importtabulartable{ininitemul-code5}{Coderingstabel van de oneindige vermenigvuldiger.}
...
% \importtabulartable{ininitemul-combine5}{De oneindige vermenigvuldiger.}
Wanneer we D-flipflops gebruiken bekomen dienen we combinatorische schakelingen te implementeren zoals op \figref{ininitemul-combine5} een grafische voorstelling met behulp van Karnaugh-kaarten staat op \figref{ininitemul-karnaugh5}.

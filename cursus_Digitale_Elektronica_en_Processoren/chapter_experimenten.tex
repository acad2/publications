...
Wanneer we D-flipflops gebruiken bekomen dienen we combinatorische schakelingen te implementeren zoals op \figref{ininitemul-combine5} een grafische voorstelling met behulp van Karnaugh-kaarten staat op \figref{infinitemul-karnaugh5}.
\importtikzfigure{ininitemul-karnaugh5}{Karnaugh-kaarten voor de oneindige vermenigvuldiger.}

...
\subfigure[Uitlezen]{
\begin{tikzpicture}
\begin{wave}[0.5]{3}{6.5}
 \nextwave{Adres} \unknown{0.5} \known{Adres}{4} \unknown{2}
 \nextwave{$CS\cdot R/W^*$} \bit{0}{0.5}\bit{1}{4}\bit{0}{2}
 \nextwave{$D_{out}$} \unknownbit{2} \unknown{1} \known{geldig}{2} \unknownbit{1.5}
\end{wave}
\end{tikzpicture}
...
\begin{wave}[0.5]{3}{6.5}
 \nextwave{Adres} \unknown{0.5} \known{Adres}{4} \unknown{2}
 \nextwave{$CS\cdot\left(R/W^*\right)'$} \bit{0}{0.5}\bit{1}{4}\bit{0}{2}
 \nextwave{$D_{in}$} \known{don't care}{3}\known{geldig}{2} \unknown{1.5}
\end{wave}
\end{tikzpicture}

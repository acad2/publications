...
\paragraph{}
RAM-geheugens hebben complex tijdsgedrag. Daarom zullen we de twee scenario's: het uitlezen en wegschrijven van data bespreken samen met de verschillende vormen van vertraging. Verder zullen we ook enkele typische grenzen van vertragingstijden voor RAM-geheugen geven in tabel \ref{tbl:rAMDelaySamples}.
\begin{table}[hbt]
\centering
\begin{tabular}{clrr}
\hline
$t_{RC}$&cyclustijd lezen&35 ns&\\
$t_{AA}$&toegangstijd&&35 ns\\
$t_{ACS}$&$CS$ toegangstijd&&35 ns\\
$t_{HZ}$&$CS'\rightarrow Z$&0 ns&30 ns\\\hline
$t_{WC}$&cyclustijd schrijven&35 ns&\\
$t_{DW}$&data set-up-tijd&20 ns&\\
$t_{DH}$&data houdtijd&0 ns&\\
\end{tabular}

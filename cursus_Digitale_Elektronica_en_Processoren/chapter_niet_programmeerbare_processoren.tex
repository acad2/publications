...
\node[asmD] (S1D) at (0,-2) {$ci=0$};
\draw[->] (S1S) -- (S1D);
\draw[->] (S1D) -| (-2,0) -- (S1S);
\draw (-2,-2) node[anchor=south west,scale=0.75]{[True]};
\draw (2,-2) node[anchor=south east,scale=0.75]{[False]};

\node[asmS] (S2S) at (5,0) {$\begin{array}{c}X\gets N\\I\gets I-1\\co=0\end{array}$};
\node[asmD] (S2D1) at (5,-2) {$ $};
\node[asmD] (S2D2) at (5,-6) {$I>0$};
\draw[->] (S1D) -| (2,1) -| (S2S);
\draw[->] (S2D2) -| (3,0) -- (S2S);
\draw (3,-6) node[anchor=south west,scale=0.75]{[True]};
\draw (7,-6) node[anchor=south east,scale=0.75]{[False]};

\node[asmS] (S3S) at (10,0) {$\begin{array}{c}co=1\end{array}$};
\node[asmD] (S3D) at (10,-2) {$ci=1$};
\draw[->] (S2D2) -| (7,1) -| (S3S);
\draw[->] (S3S) -- (S3D);
\draw[->] (S3D) -| (8,0) -- (S3S);
\draw (8,-2) node[anchor=south west,scale=0.75]{[True]};
\draw (12,-2) node[anchor=south east,scale=0.75]{[False]};
\draw[->] (S3D) -| (12,1.5) -| (S1S);

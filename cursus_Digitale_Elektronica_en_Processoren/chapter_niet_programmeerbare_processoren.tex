...
\end{itemize}
Het algoritme berekent vervolgens twee sets per toestand:
\begin{itemize}
 \item $\instt{n}$
 \item $\outstt{n}$
\end{itemize}
...
\Return $\left(\instt{n},\outstt{n}\right)$
\EndFunction
\end{algorithmic}
\end{algorithm}
\begin{table}[hbt]
\centering
\begin{tabular}{c|ccc}
$n$&$\succst{n}$&$\usestt{n}$&$\defstt{n}$\\\hline
0&$\left\{0,1\right\}$&$\emptyset$&$\left\{t_1,t_2\right\}$\\
1&$\left\{2\right\}$&$\left\{t_1,t_2\right\}$&$\left\{t_3,t_4\right\}$\\
2&$\left\{3\right\}$&$\left\{t_3,t_4\right\}$&$\left\{t_5,t_6\right\}$\\
3&$\left\{4\right\}$&$\left\{t_5,t_6\right\}$&$\left\{t_7,t_8\right\}$\\
4&$\left\{5\right\}$&$\left\{t_5,t_7\right\}$&$\left\{t_9\right\}$\\
5&$\left\{6\right\}$&$\left\{t_8,t_9\right\}$&$\left\{t_{10}\right\}$\\
6&$\left\{7\right\}$&$\left\{t_5,t_{10}\right\}$&$\left\{t_{11}\right\}$\\
7&$\left\{0\right\}$&$\emptyset$&$\emptyset$
\end{tabular}
\caption{Tabellen op basis van het leidend voorbeeld (zie figuur \ref{fig:asmSqrt})}
\end{table}
\begin{table}[hbt]
\centering
\begin{tabular}{c|cc|cc|cc}
$n$&$\instt{n}$&$\outstt{n}$&$\instt{n}$&$\outstt{n}$&$\instt{n}$&$\outstt{n}$\\\hline
0&	$\emptyset$&		\accol{t_1,t_2}&	$\emptyset$&		\accol{t_1,t_2}&	$\emptyset$&		\accol{t_1,t_2}\\
1&	\accol{t_1,t_2}&	\accol{t_3,t_4}&	\accol{t_1,t_2}&	\accol{t_3,t_4}&	\accol{t_1,t_2}&	\accol{t_3,t_4}\\
2&	\accol{t_3,t_4}&	\accol{t_5,t_6}&	\accol{t_3,t_4}&	\accol{t_5,t_6}&	\accol{t_3,t_4}&	\accol{t_5,t_6}\\
3&	\accol{t_5,t_6}&	\accol{t_5,t_7}&	\accol{t_5,t_6}&	\accol{t_5,t_7,t_8}&	\accol{t_5,t_6}&	\accol{t_5,t_7,t_8}\\
4&	\accol{t_5,t_7}&	\accol{t_8,t_9}&	\accol{t_5,t_7,t_8}&	\accol{t_5,t_8,t_9}&	\accol{t_5,t_7,t_8}&	\accol{t_5,t_8,t_9}\\
5&	\accol{t_8,t_9}&	\accol{t_5,t_{10}}&	\accol{t_5,t_8,t_9}&	\accol{t_5,t_{10}}&	\accol{t_5,t_8,t_9}&	\accol{t_5,t_{10}}\\
6&	\accol{t_5,t_{10}}&	$\emptyset$&		\accol{t_5,t_{10}}&	$\emptyset$&		\accol{t_5,t_{10}}&	$\emptyset$\\

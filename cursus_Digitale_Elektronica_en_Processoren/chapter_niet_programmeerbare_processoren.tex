...
\acclarray{\accl{\mbox{abs1},\mbox{max1},+,-},\accl{\mbox{abs1},\mbox{max2},+,-},\accl{\mbox{abs1},\mbox{max1},\mbox{max2},+,-}\\\accl{\mbox{abs2},\mbox{max1},+,-},\accl{\mbox{abs2},\mbox{max2},+,-},\accl{\mbox{abs2},\mbox{max1},\mbox{max2},+,-}}
\end{equation}
\paragraph{Min\&Sub} We onderzoeken ook het samenvoegen van minimum- en verschil-bewerkingen. Uit de implementatie van minumum en maximum weten we al dat we daarvoor het teken van het verschil moeten berekenen. Daarom verwachten we dat het samenvoegen van de componenten winst kan opleveren.
...
\paragraph{Uiteindelijk compatibiliteitsgrafe} Nu we alle mogelijke combinaties hebben uitgeprobeerd bekomen we de compatibiliteitsgrafe of \figref{compatibilitygraph-functionals-final}. Op de prioriteitsranden staat de winst in transistors per bit.
\begin{figure}[hbt]
\centering
...
\foreach \a/\b/\t/\o in {f4/f5/32/,f3/f5/32/,f1/f3/2/,f2/f3/2/,f1/f4/2/,f2/f4/2/,f1/f5/2/,f2/f5/2/bend right,f6/f7/14/} {
  \path [thick] (\a) edge [\o] node[sloped,midway] {\t} (\b);
}
\foreach \n/\c/\t/\o in {A/{3,-4.5}/34/,B/{6,1.5}/34/{anchor=south},C/{6,-4.5}/22/,D/{4.5,-6}/48/,E/{4.5,3}/48/,F/{2,-6}/12/,G/{7,-6}/12/,H/{2,3}/12/,I/{7,3}/12/} {
  \coordinate (group-\n) at (\c);
  \pdot{\c};
  \draw (\c) node[anchor=north,\o] {\t};
}
\foreach \n/\p/\o in {A/f2/bend left,A/f4/,A/f5/bend right,B/f1/,B/f4/,B/f5/,C/f4/bend left,C/f5/,C/f6/bend right,D/f2/,D/f4/,D/f5/,D/f6/,E/f1/,E/f4/,E/f5/,E/f6/,F/f2/,F/f4/,F/f6/,G/f2/,G/f5/,G/f6/,H/f1/,H/f4/,H/f6/,I/f1/,I/f5/,I/f6/} {
  \path [thick] (group-\n) edge [\o] (\p);
}
\end{tikzpicture}

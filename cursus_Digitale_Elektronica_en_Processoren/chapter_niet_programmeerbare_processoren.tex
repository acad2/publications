...
De verzameling van stuursignalen noemt men doorgaans het \termen{instructiewoord}. Het is immers een verzameling van bits die voor het datapad de operatie die moet worden uitgevoerd verder specificeert. \figref{instructionword-example}
\importtikzfigure{instructionword-example}{}

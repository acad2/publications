...
\importtikzfigure{synchronization-multi}{De verschillende componenten van de ``metastability resolution time''.}
\importtikzfigure{synchronization-freq}{De verschillende componenten van de ``metastability resolution time''.}
% \begin{figure}[hbt]

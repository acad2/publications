...
de deler nooit gelijk is aan 0. Het algoritme dat dan vervolgens het deeltal en de deler omzet in het quoti\"ent en rest staat op \algoref{devisionFSMD}.
\begin{algorithm}[hbt]
...
\end{itemize}
Het algoritme die deze sets kan berekenen staat in \algoref{calculatingLiveness}.
\begin{algorithm}[hbt]

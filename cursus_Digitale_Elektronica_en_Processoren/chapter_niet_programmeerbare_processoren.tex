...
\paragraph{Abs\&max}
Een volgende combinatie die we uitproberen is het berekenen van een absolute waarde en het maximum. Omdat we in de vorige paragraaf besproken hebben dat het minimum en maximum zeer gelijkaardig zijn, gelden alle uitspraken ook voor een component $\mbox{abs\&min}$.
\begin{figure}[hbt]
\centering
...
\foreach \a/\b/\t/\o in {f4/f5/{32/2}/,f3/f5/{32/2}/} {

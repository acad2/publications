...
\foreach \a/\b/\t/\o in {f1/f3/2/,f3/f7/14/,f7/f6/14/,f4/f5/32/} {
  \path [thick] (\a) edge [\o] node[sloped,above,midway] {\t} (\b);
}
\foreach \n/\c/\t/\o in {A/{4.5,-1.5}/92/,B/{4.5,1.5}/28/,C/{3,-4.5}/34/,D/{6,-4.5}/22/,E/{4.5,-6}/54/} {
  \coordinate (group-\n) at (\c);
  \pdot{\c};
  \draw (\c) node[anchor=north,\o] {\t};
}
\foreach \n/\p/\o in {A/f2/bend right,A/f4/bend right,A/f5/bend left,A/f6/bend left,A/f7/,B/f1/bend right,B/f3/,B/f7/bend left,C/f2/bend left,C/f4/,C/f5/bend right,D/f4/bend left,D/f5/,D/f6/bend right,E/f2/bend left,E/f4/,E/f5/,E/f6/bend right} {
  \path [thick] (group-\n) edge [\o] (\p);
}
\end{tikzpicture}

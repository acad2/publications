...
\node[asmD] (T0) at (-1.75,-1.75) {$t_1$};
\node[asmD] (T1) at (1.75,-1.75) {$t_2$};
\node[asmS] (A1) at (-3,-3.5) {$A_1$};
\node[asmS] (A2) at (0,-3.5) {$A_2$};
\node[asmS] (A3) at (3,-3.5) {$A_3$};
...
\begin{tikzpicture}
\node[asmS] (A0) at (0,0) {$A_0$};
\node[asmD] (T0) at (0,-1.75) {$t_1$};
\node[asmS] (A1) at (1.25,-3.5) {$A_1$};
\setTrueFalseLabels{T0};
\draw[->] (A0) -- (T0);
\draw[->] (T0) -| (A1);
\draw[<-] (A0) -- ++(0,1);
\draw (T0) -| (-1.25,-0.75) -- (0,-0.75);
\pdot{0,-0.75};
\begin{pgfonlayer}{background}
...
\node[asmS] (A2) at (0,-3) {$A_0$};
\setTrueFalseLabels{T0};
\draw[->] (A0) -- (T0);
\draw[->] (T0) -| (A1);
\draw[<-] (A0) -- ++(0,1);
\draw[->] (T0) -| (-1.25,-2.25) -| (A2);
\draw (A1) |- (0,-2.25);
\pdot{0,-2.25};
\begin{pgfonlayer}{background}

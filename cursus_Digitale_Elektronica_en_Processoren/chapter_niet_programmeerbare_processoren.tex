...
\foreach \n/\t/\p in {t1/$t_1$/,t2/$t_2$/[below of=t1],t3/$t_3$/[right of=t1],t4/$t_4$/[below of=t3],t11/$t_7$/[right of=t3],t10/$t_10$/[below of=t11],t5/$t_5$/[right of=t11],t9/$t_9$/[below of=t5],t7/$t_7$/[right of=t9],t8/$t_8$/[right of=t7],t6/$t_6$/[above of=t8]} {
  \node[draw=black,minimal width=1 cm, minimal height=1cm,circle] (\n) \p {\t};
}
...
\foreach \tim/\off/\vars in {1/t5/,1/t7/,1/t8/,2/t5/{t3,t11},2/t8/{t6,t8},2/t7/{t4,t9,t10},3/t5/{t1,t3,t11},3/t7/{t2,t4,t9,t10}} {
  ...
  %\node [fit=\vars,draw=dashed,rectangle,black] {};
}
\end{tikzpicture}

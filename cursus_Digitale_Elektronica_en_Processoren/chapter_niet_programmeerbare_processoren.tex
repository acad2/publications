...
\foreach \a/\b/\t/\o in {f4/f5/{32/2}/,f3/f5/{32/2}/,f1/f3/{2/0}/,f2/f3/{2/0}/,f1/f4/{2/0}/,f2/f4/{2/0}/,f1/f5/{2/0}/,f2/f5/{2/0}/bend right,f6/f7/{14/1}/} {
  \path [thick] (\a) edge [\o] node[sloped,midway] {\t} (\b);
}
\foreach \n/\c/\t/\o in {A/{3,-4.5}/{34/2}/,B/{6,1.5}/{34/2}/{anchor=south}} {
  \coordinate (group-\n) at (\c);
  \pdot{\c};
  \draw (\c) node[anchor=north,\o] {\t};
}
\foreach \n/\p/\o in {A/f2/bend left,A/f4/,A/f5/bend right,B/f1/,B/f4/,B/f5/} {
  \path [thick] (group-\n) edge [\o] (\p);
}
\end{tikzpicture}

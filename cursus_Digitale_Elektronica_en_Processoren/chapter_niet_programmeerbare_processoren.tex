...
\begin{sprocessor}[1.25/4.6/1.3/1.4/0.25/0.8]{t1/{$t_1$}/1/3,t2/{$t_2$}/1/4,t6/{$t_6$}/1/2}{abs1/$\abs$,abs2/$\abs$,max1/$\max$,min/$\min$,shr3/$\shrcmd3$,shr1/$\shrcmd1$,sub/$-$,add/$+$,max2/$\max$}{}
\sprbtf{t1}{abs1}{0};
\sprbtf{t2}{abs2}{-0.2};
\sprbtf{t1}{max1}{-0.3};
\sprbtf{t2}{max1}{0.3};

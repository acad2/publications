...
\begin{figure}[hbt]
\centering
\begin{sprocessor}[1.5]{t1/$t_1$/1/1,t2/$t_2$/1/1,t3/$t_3$/1/1,t4/$t_4$/1/1,t5/$t_5$/1/1,t6/$t_6$/1/1,t7/$t_7$/1/1,t8/$t_8$/1/1}{shr3/$\shrcmd3$,shr1/$\shrcmd1$,sub/$-$,add/$+$,max1/$\max$, max2/$\max$,min/$\min$}{}
%, t9/$t_9$/1/1,t10/$t_{10}$/1/1,t11/$t_{11}$/1/1
%,abs1/$\abs$,abs2/$\abs$
\end{sprocessor}

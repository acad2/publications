...
\foreach \n/\c/\t/\o in {A/{3,-4.5}/{34/2}/,B/{6,1.5}/{34/2}/{anchor=south},C/{6,-4.5}/{22/1}/,D/{4.5,-6}/{/}/} {
  \coordinate (group-\n) at (\c);
  \pdot{\c};
  \draw (\c) node[anchor=north,\o] {\t};
}
\foreach \n/\p/\o in {A/f2/bend left,A/f4/,A/f5/bend right,B/f1/,B/f4/,B/f5/,C/f4/bend left,C/f5/,C/f6/bend right,D/f2/bend left,D/f4/,D/f5/,D/f6/bend right} {
  \path [thick] (group-\n) edge [\o] (\p);
}
\end{tikzpicture}

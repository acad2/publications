...
\foreach \tim/\off/\vars in {1/t5/,1/t7/,1/t8/,2/t5/{t3,t11},2/t8/{t6,t8},2/t7/{t4,t9,t10},3/t5/{t1,t3,t11},3/t7/{t2,t4,t9,t10}} {
  \node[fit=(\off),inner sep=2*\tim pt] (fitnode) {};
  \foreach \var in \vars {
    \node[fit=(\var),inner sep=2*\tim pt] (thick\var) {};
    \node[fit=(fitnode) (thick\var),inner sep=0pt] (fitnode) {};
  }
  \node [fit=(fitnode),inner sep=0pt,draw,dashed,rectangle,draw=black,fill=gray!20,semitransparent] {};
}
\end{pgfonlayer}
\end{tikzpicture}

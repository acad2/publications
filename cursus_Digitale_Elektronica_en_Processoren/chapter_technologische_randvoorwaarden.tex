...
\begin{itemize}
 \item \termen{Ingangsimpedantie $R_I$}: We streven naar een zo hoog mogelijke ingangsimpedantie, immers stelt vergelijking (\ref{eqn:vInfty}) dat indien $R_I\gg R_O$, $V_{\infty}\approx V_{DD}$. Bovendien is het statisch vermogenverbruik lager (zie vergelijk \ref{eqn:PVTsummary}).
...
\draw plot[thick,samples=7,black!80,variable=\x,domain=0:1,smooth] (\x,{0.95+0.025*rand-0.0125}) -- plot[thick,samples=14,black!80,variable=\x,domain=1.5:3.5,smooth] (\x,{0.95-0.45*\x+1.5*0.45+0.025*rand-0.0125}) -- plot[thick,samples=21,black!80,variable=\x,domain=3.5:6.35,smooth] (\x,{0.05+0.025*rand-0.0125}) -- plot[thick,samples=7,black!80,variable=\x,domain=6.35:7.35,smooth] (\x,{0.05+0.9*\x-0.9*6.35+0.025*rand-0.0125}) -- plot[thick,samples=21,black!80,variable=\x,domain=7.35:10,smooth] (\x,{0.95+0.025*rand-0.0125});
\end{scope}
\end{tikzpicture}

...
\coordinate (D1X) at (0,0);
\coordinate (D1X0) at (1.5*\dxy,0);
\coordinate (D1X1) at (-1.5*\dxy,0);
\coordinate (D1X00) at (4.5*\dxt,0);
\coordinate (D1X01) at (\dxt,0);
\coordinate (D1X10) at (-2*\dxt,0);
\coordinate (D1X11) at (-5*\dxt,0);
\coordinate (D1X00000) at (6*\dxt,0);
\coordinate (D1X00001) at (5*\dxt,0);
\coordinate (D1X00010) at (4*\dxt,0);
\coordinate (D1X00100) at (3*\dxt,0);
\coordinate (D1X01010) at (2*\dxt,0);
\coordinate (D1X01011) at (1*\dxt,0);
\coordinate (D1X01101) at (0*\dxt,0);
\coordinate (D1X10001) at (-1*\dxt,0);
\coordinate (D1X10010) at (-2*\dxt,0);
\coordinate (D1X10100) at (-3*\dxt,0);
\coordinate (D1X11010) at (-4*\dxt,0);
\coordinate (D1X11011) at (-5*\dxt,0);
\coordinate (D1X11101) at (-6*\dxt,0);

\node[fcstateblock,rotate=-90] (NFI) at (FI) {$\begin{array}{l}\cmdloadir\\\cmdpccinc\end{array}$};

\foreach \r/\i/\y/\x/\t in {d/N/O/O/$\dbirab$,b/N01/D1Y1/D1X/$\dbirca$,b/N010/D1Y2/D1X0/$\dbirda$,b/N011/D1Y2/D1X1/$\dbirda$,h/N0111/D1Y3/D1X11/$\dbirec$,h/N0110/D1Y3/D1X10/$\dbirec$,h/N0101/D1Y3/D1X01/$\dbirec$,h/N0100/D1Y3/D1X00/$\dbirec$} {
  \node[fcdecisionblocks\r,rotate=-90] (\i) at (\x |- \y) {\t};
}

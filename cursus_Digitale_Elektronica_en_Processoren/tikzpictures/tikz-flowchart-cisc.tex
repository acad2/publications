...
\begin{scope}[yshift=2*\dy cm,rotate=-90]
  ...
  \foreach \i/\x/\o/\t in {00/1/0/{\jmpr},10/-1/2/{\saves\\\pushs\\\jmpr}} {
	\begin{scope}[xshift=\x cm]
	  \node[fcstateblock,rotate=-90] (ISF-10\i) at (\x,0 |- IOH) {$\begin{array}{l}\t\end{array}$};\draw[thick,->] (ISC-10.output\o) -- (ISC-10.output\o |- IPD) -| (ISF-10\i.north);
	\end{scope}
  }
\end{scope}

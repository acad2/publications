...
\begin{scope}[yshift=2*\dy cm,rotate=-90]
  ...
  \foreach \i/\x/\o/\r/\t in {00/1/0/IPF/{\jmpr},10/-1/2/IOF/{\saves\\\pushs\\\jmpr},11/-1.75/3/IOG/{\popss\\\loadpcs}} {
	\begin{scope}[xshift=\x cm]
...
\begin{scope}[rotate=90]
  ...
  \node[fcdecisionblockdh] (ISD-0010) at (-1,0 |- IQE) {$\mbox{IR}_{11}\mbox{IR}_{10}$};\draw[thick,->] (ISC-00.output2) -- (ISC-00.output2 |- IRD) -| (ISD-0010.input);
	\node[fcdecisionblockhh] (ISD-0011) at (-3,0 |- IQH) {$\mbox{IR}_{11}\mbox{IR}_{10}\mbox{IR}_{9}$};\draw[thick,->] (ISC-00.output3) -- (ISC-00.output3 |- IRD) -| (ISD-0011.input);
  \begin{scope}[xshift=-3 cm]
	...
	\begin{scope}[xshift=\x cm]
	  \node[fcstateblock] (ISF-0010\i) at (ISD-0011.output\o|- IQJ) {$\texttt{RF[d]}\leftarrow\texttt{RF[s1] \t{} RF[s2]}$};\draw[thick,->] (ISD-0011.output\o) -- (ISF-0010\i.west);
	...
	\begin{scope}[xshift=\x cm]
	  \node[fcstateblock] (ISF-0010\i) at (ISD-0011.output\o |- IQJ) {$\texttt{RF[d]}\leftarrow\texttt{\t{}}$};\draw[thick,->] (ISD-0011.output\o) -- (ISF-0010\i.west);
	  \draw[thick] (ISF-0010\i.east) -- (ISF-0010\i.east |- RETC);
	  \pdot{ISF-0010\i.east |- RETC};
	\end{scope}
	}
...
\node[fcdecisionblockbi] (ISD-1101) at (5,0 |- ISD) {$\mbox{IR}_{11}$};\draw[thick,->] (ISD-11.output1) -- (ISD-11.output1 |- ITC) -| (ISD-1101.input);
\node[fcdecisionblockhi] (ISD-1110) at (0.5,0 |- ISD) {$\mbox{IR}_{11}\mbox{IR}_{10}\mbox{IR}_{10}$};\draw[thick,->] (ISD-11.output2) -- (ISD-11.output2 |- ITC) -| (ISD-1110.input);
\node[fcstateblock,rotate=180] (ISF-1111) at (-1.5,0 |- ISB) {$\texttt{Status}\leftarrow1$};\draw[thick,->] (ISD-11.output3) -- (ISD-11.output3 |- ITZ) -| (ISF-1111.north);\draw[thick] (ISF-1111.south) |- (RETA |- ITA);
\draw[thick] (ISD-11.output0) |- (RETB |- ITC);
\pdot{RETB |- ITC}
\pdot{RETA |- ITA}
\end{scope}

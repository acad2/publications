...
\end{scope}
\end{scope}}
\node[pcbdip,pcblabel=7474,rotate=90] (MM1) at (0,-3) {};
\node[pcbdip,pcblabel=7474,rotate=90] (MM2) at (2,-3) {};
\node[pcbdip,pcblabel=7407,rotate=90] (MM3) at (4,-3) {};
\node[pcbdip,pcblabel=7410,rotate=90] (NN1) at (0,-5) {};
\node[pcbdip,pcblabel=7410,rotate=90] (NN2) at (2,-5) {};
\node[pcbdip,pcblabel=7410,rotate=90] (NN3) at (4,-5) {};
\begin{scope}[gray]
\begin{pgfonlayer}{background}
\pcbpintopin{USB.pin0}{VSS0}
\pcbpintopin{VDD0}{USB.pin3}

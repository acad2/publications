...
\end{scope}
\end{scope}}
\node[pcbdip,pcblabel=7407,rotate=90] (NG61) at (0,-3) {};
\node[pcbdip,pcblabel=7474,rotate=90] (DFF1) at (2,-3) {};
\node[pcbdip,pcblabel=7474,rotate=90] (DFF2) at (4,-3) {};
\node[pcbdip,pcblabel=7410,rotate=90] (NN61) at (0,-5) {};
\node[pcbdip,pcblabel=7410,rotate=90] (NN62) at (2,-5) {};
\node[pcbdip,pcblabel=7410,rotate=90] (NN63) at (4,-5) {};
\begin{scope}[gray]
\begin{pgfonlayer}{background}

...
\draw[thick] (AB -| CT.east) -- (AB -| CT.west);
\draw[thick] (DB -| CT.east) -- (DB -| CT.west);
\node[subcomp,anchor=north] (Mem) at (2,0 |- MT) {Mem\\ \\Data\\\&\\Prog.};
...
\node[tris,rotate=-90,fill=white,thick] (TS) at (TSL) {};
\node[tris,rotate=-90,fill=white,thick] (TI) at (TIL) {};
\draw[thick] (SR) -| (TS.x);

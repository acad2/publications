...
\node[subcomp] (Co) at (2,-1) {Comp};\coordinate (Co-I0) at ($0.333*(Co.north east)+0.667*(Co.north west)$); \coordinate (Co-I1) at ($0.667*(Co.north east)+0.667*(Co.north west)$); \coordinate (Co-O0) at (Co.south);

...
\vhdltermen{constant}\ \textit{identifier}\ \vhdltermen{:}\ \textit{type}\ \vhdltermen{:=}\ \textit{waarde}\vhdltermen{;}
\end{equation}
...
\vhdlref{constante} toont enkele voorbeelden van constante-declaraties. Zo defini\"eren we \texttt{pi} en \texttt{byte\_length} aan de hand van waarden, \texttt{word\_length} wordt gedefini\"eerd aan de hand van een expressie waarin zowel een waarde en een constante betrokken zijn.

...
De logische bewerkingen komen grotendeels overeen met de beschouwden poorten in \chpref{basis}. Dit zijn dus de \vhdltermen{not}, \vhdltermen{and}, \vhdltermen{or}, \vhdltermen{xor}, \vhdltermen{nand}, \vhdltermen{nor} en \vhdltermen{xnor}\footnote{\vhdltermen{xnor} is niet beschikbaar is \tvhdl{}'87.}.
op \vhdltermen{bit}, \vhdltermen{boolean}, \vhdltermen{std\_logic} en op afgeleide ``array aggregaten''\footnote{Dit op voorwaarde dat de dimensies van de twee arrays identiek zijn, de operatie wordt dan elementgewijs toegepast.}.

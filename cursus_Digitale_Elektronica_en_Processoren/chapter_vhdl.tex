...
\section{Typesysteem}
VHDL is getypeerd: een variabele slaat data op volgens een bepaald type. De types kunnen bovendien door de programmeur uitgebreid worden. Men vertrekt echter steeds van basistypes.

\paragraph{}

Ook in de VHDL-secties werden sommige van deze types reeds gebruikt. \tblref{vHDLTypes} geeft een overzicht van de meest populaire hoofdtypes.
\begin{table}[hbt]
\centering

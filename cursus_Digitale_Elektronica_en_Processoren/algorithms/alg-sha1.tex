...
\EndFor
\State \textbf{return} $\brak{h_0\shlcmd128}\orcmd{}\brak{h_1\shlcmd96}\orcmd{}\brak{h_2\shlcmd64}\orcmd{}\brak{h_3\shlcmd32}\orcmd{}\brak{h_4}$\Comment{De uiteindelijke partitie.}
\EndProcedure
\end{algorithmic}
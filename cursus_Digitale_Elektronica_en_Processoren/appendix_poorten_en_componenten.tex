...
\ssclab{appendixComplexePoorten}

%REVIEW
\begin{table}
\centering
\importtabularsubtable{truth-complex-nand}{Nand.}
\importtabularsubtable{truth-complex-nor}{Nor.}
\importtabularsubtable{truth-complex-xor}{Xor.}
\importtabularsubtable{truth-complex-xnor}{Xnor.}
\tbllab{truth-complex}

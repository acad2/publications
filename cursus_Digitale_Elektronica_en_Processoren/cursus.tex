...
\paragraph{}
Speciale dank gaat naar (in alfabetische volgorde) ``Moby'', ``Ruskii Razmer'', ``Harold Budd'', ``Paul Simon'', ``Amy Winehouse'', ``The Beatles'', ``Piknik'' en ``Hooverphonic'' voor de muziek tijdens de nachten waarin deze cursus tot stand kwam.
...
\paragraph{}Deze cursus is opgedragen aan Louis Van Onsem (1931-1993), voor drie jaar en vier maanden peterschap, en m'n derde voornaam: Agnes.
\end{it}
\commusoftQuality{1}

...
\paragraph{}Deze cursus is opgedragen aan:
\begin{itemize}
 \item \textsc{Gabriella Simons (1923-2012)}: voor haar humor en fijne herinneringen.
 \item \textsc{Louis Van Onsem (1931-1993)}: voor drie jaar en vier maanden peterschap en m'n derde voornaam: \textsc{Agnes}.
\end{itemize}
\end{it}
\commusoftQuality{1}

...
\pgfdeclareshape{pcbr} {
  ...
  \backgroundpath{
    ...
    \centerpoint\advance\pgf@x by-\halfwidth
    \pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
    \centerpoint\advance\pgf@x by-0.6666\pgfutil@tempdima\pgf@xa=\pgf@x\pgf@ya=\pgf@y\advance\pgf@ya by-\halfheight
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \centerpoint\advance\pgf@x by\halfwidth
    \pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
    \centerpoint\advance\pgf@x by0.6666\pgfutil@tempdima\pgf@xb=\pgf@x\pgf@yb=\pgf@y\advance\pgf@yb by\halfheight
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}

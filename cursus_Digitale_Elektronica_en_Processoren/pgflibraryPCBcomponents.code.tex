...
\pgfdeclareshape{pcbled} {
  \inheritsavedanchors[from=pcbbase]
  \anchor{pina}{\pgfutil@tempdimc=\circlediff\centerpoint\advance\pgf@y by0.5\pgfutil@tempdimc}
  \anchor{pinb}{\pgfutil@tempdimc=\circlediff\centerpoint\advance\pgf@y by-0.5\pgfutil@tempdimc}

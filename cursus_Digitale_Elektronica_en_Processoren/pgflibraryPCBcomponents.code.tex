...
\pgfdeclareshape{pcbto92} {
  ...
  \anchor{collector}{\pgfutil@tempdimc=\circlediff\centerpoint\advance\pgf@x by-\pgfutil@tempdimc}
  \anchor{basis}{\centerpoint}
  \anchor{base}{\centerpoint}
  \anchor{emitter}{\pgfutil@tempdimc=\circlediff\centerpoint\advance\pgf@x by\pgfutil@tempdimc}
  \saveddimen\circlein{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbcirclein}}}
  \saveddimen\circleout{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbcircleout}}}
...
\pgfdeclareshape{pcbconnusb} {
  ...
  \backgroundpath{
    ...
    \color{black}
    \pgfsetlinewidth{2\pgflinewidth}
    \pgf@anchor@pcbconnusb@bara\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}

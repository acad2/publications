...
\pgfdeclareshape{pcbr} {
  ...
  \backgroundpath{
    \pgfseteorule
    \pgfutil@tempdima=\halfwidth
    \pgfutil@tempdimb=0.05\pgfutil@tempdima
    ...
    \color{gray}
    \pgfusepath{fill}
    \centerpoint\advance\pgf@x by-\halfwidth\advance\pgf@x by-\pgfutil@tempdimb\advance\pgf@y by\pgfutil@tempdimb
    \pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@x by10\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@y by5\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@x by22\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@y by-5\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@x by10\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@y by-2\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@x by-10\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@y by-5\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@x by-22\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@y by5\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@x by-10\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \pgfpathclose
    \centerpoint\advance\pgf@x by-\halfwidth\advance\pgf@x by11\pgfutil@tempdimb\advance\pgf@y by4\pgfutil@tempdimb
    \pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@x by18\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@y by-8\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \advance\pgf@x by-18\pgfutil@tempdimb
    \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \pgfpathclose
    \color{black}
    \pgfusepath{fill}

...
\pgfdeclareshape{pcbconnusb} {
  \inheritsavedanchors[from=pcbbase]
  \anchor{pina}{\pgfutil@tempdima=\circlediff\centerpoint\advance\pgf@x by0.5\pgfutil@tempdima\advance\pgf@y by0.5\pgfutil@tempdima}
  \anchor{pinb}{\pgfutil@tempdima=\circlediff\centerpoint\advance\pgf@x by-0.5\pgfutil@tempdima\advance\pgf@y by0.5\pgfutil@tempdima}
  \anchor{pinc}{\pgfutil@tempdima=\circlediff\centerpoint\advance\pgf@x by-0.5\pgfutil@tempdima\advance\pgf@y by-0.5\pgfutil@tempdima}
  \anchor{pind}{\pgfutil@tempdima=\circlediff\centerpoint\advance\pgf@x by0.5\pgfutil@tempdima\advance\pgf@y by-0.5\pgfutil@tempdima}

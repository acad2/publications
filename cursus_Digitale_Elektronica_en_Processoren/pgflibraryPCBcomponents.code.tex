...
\pgfkeys{/pgf/.cd,
  ...
  pcbacywidth/.initial=0.005 cm,
  pcbacythick/.initial=0.0016 cm,
...
\pgfdeclareshape{pcbacy} {
  ...
  \saveddimen\circlein{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbcirclein}}}
  \saveddimen\circleout{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbcircleout}}}
  \saveddimen\acywidth{\pgfmathmultiply{\pgfkeysvalueof{/pgf/pcbacywidth}}{\pgfkeysvalueof{/pgf/pcbacyindex}}\pgfmathsetlength{\pgf@x}{\pgfmathresult}}
  \saveddimen\acythick{\pgfmathmultiply{\pgfkeysvalueof{/pgf/pcbacythick}}{\pgfkeysvalueof{/pgf/pcbacyindex}}\pgfmathsetlength{\pgf@x}{\pgfmathresult}}
  ...
  \backgroundpath{
    ...
    \pgfutil@tempdima=\circlein
    \pgfutil@tempdimb=\circleout
    \pgfutil@tempdimc=\acywidth
    \advance\pgfutil@tempdimc by\acywire
    \centerpoint\advance\pgf@x by-0.5\pgfutil@tempdimc\pgfpathcircle{\pgfpoint{\pgf@x}{\pgf@y}}{\pgfutil@tempdima}
    \centerpoint\advance\pgf@x by-0.5\pgfutil@tempdimc\pgfpathcircle{\pgfpoint{\pgf@x}{\pgf@y}}{\pgfutil@tempdimb}
    \centerpoint\advance\pgf@x by0.5\pgfutil@tempdimc\pgfpathcircle{\pgfpoint{\pgf@x}{\pgf@y}}{\pgfutil@tempdima}
    \centerpoint\advance\pgf@x by0.5\pgfutil@tempdimc\pgfpathcircle{\pgfpoint{\pgf@x}{\pgf@y}}{\pgfutil@tempdimb}

...
\pgfdeclareshape{pcbzip} {
  ...
  \backgroundpath{
    ...
    \pgfusepath{fill}
    \color{black}
%     \advance\pgfutil@tempdime by-1\pgfutil@tempdimc
%     \centerpoint\advance\pgf@x by-\pgfutil@tempdimd\advance\pgf@x by-0.5\pgfutil@tempdimc\advance\pgf@y by-\pgfutil@tempdime\pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
%     \centerpoint\advance\pgf@x by\pgfutil@tempdimd\advance\pgf@x by-0.5\pgfutil@tempdimc\advance\pgf@y by-\pgfutil@tempdime\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
%     \centerpoint\advance\pgf@x by\pgfutil@tempdimd\advance\pgf@x by-0.5\pgfutil@tempdimc\advance\pgf@y by-\pgfutil@tempdime\advance\pgf@y by-\pgfutil@tempdimc\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
%     \pgfusepath{stroke}
    %\advance\pgfutil@tempdime by0.5\pgfutil@tempdimc
    \centerpoint\advance\pgf@x by-0.5\pgfutil@tempdimc\advance\pgf@x by-\pgfutil@tempdimd\advance\pgf@y by\pgfutil@tempdime\pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
    \centerpoint\advance\pgf@x by0.5\pgfutil@tempdimc\advance\pgf@x by\pgfutil@tempdimd\advance\pgf@y by\pgfutil@tempdime\pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
    \centerpoint\advance\pgf@x by0.5\pgfutil@tempdimc\advance\pgf@x by\pgfutil@tempdimd\advance\pgf@y by-\pgfutil@tempdime\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \centerpoint\advance\pgf@x by-0.5\pgfutil@tempdimc\advance\pgf@x by-\pgfutil@tempdimd\advance\pgf@y by-\pgfutil@tempdime\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}\pgfpathclose
    \pgfsetlinewidth{2\pgflinewidth}
    \pgfusepath{stroke}
  }
}

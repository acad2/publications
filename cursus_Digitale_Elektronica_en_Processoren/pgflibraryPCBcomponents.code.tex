...
%   \saveddimen\rcyradius{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbrcyradius}}}
  \saveddimen\rcymargin{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbrcymargin}}}
  \saveddimen\rcymarks{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbrcymarks}}}
  \inheritbackgroundpath[from=pcbrcy]
  \beforebackgroundpath{
%     \pgfutil@tempdima=\rcyradius
    \pgfsetlinewidth{2\pgflinewidth}
    \pgfutil@tempdima=0 cm

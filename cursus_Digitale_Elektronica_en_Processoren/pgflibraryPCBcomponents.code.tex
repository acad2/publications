...
\pgfdeclareshape{pcbto92} {
  ...
  \backgroundpath{
    ...
    \color{gray}
    \pgfusepath{fill}
    \centerpoint\pgf@xa=\pgf@x\pgf@ya=\pgf@y\advance\pgf@xa by0.707\pgfutil@tempdimc\advance\pgf@ya by0.707\pgfutil@tempdimc\pgfpathmoveto{\pgfpoint{\pgf@xa}{\pgf@ya}}
    \pgfpatharc{45}{-225}{\pgfutil@tempdimc and \pgfutil@tempdimc}

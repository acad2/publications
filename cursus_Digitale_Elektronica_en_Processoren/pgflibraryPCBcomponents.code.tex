...
\pgfdeclareshape{pcbtont} {
  ...
  \backgroundpath{
    ...
    \pgf@anchor@pcbtont@piria\pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}\pgfpatharc{45}{-225}{\pgfutil@tempdimc and \pgfutil@tempdimc}
    \pgf@anchor@pcbtont@piria\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}\pgfpathclose
    \color{black}
    \pgfusepath{stroke}
    % Draw port labels
    \begingroup

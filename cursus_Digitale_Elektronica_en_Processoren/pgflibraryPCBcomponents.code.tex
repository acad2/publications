...
\pgfdeclareshape{pcbacy} {
  \inheritsavedanchors[from=pcbbase]
  \anchor{pin0}{\pgfutil@tempdimd=\acyhalfwidth\advance\pgfutil@tempdimd by\acywire\centerpoint\advance\pgf@x by-\pgfutil@tempdimd}
  \anchor{pin1}{\pgfutil@tempdimd=\acyhalfwidth\advance\pgfutil@tempdimd by\acywire\centerpoint\advance\pgf@x by\pgfutil@tempdimd}
  \anchor{pinmarka}{\pgfutil@tempdimd=\acyhalfwidth\advance\pgfutil@tempdimd by\acywire\centerpoint\advance\pgf@x by-\pgfutil@tempdimd}
  \anchor{pinmarkb}{\pgfutil@tempdimd=\acyhalfwidth\advance\pgfutil@tempdimd by\acywire\centerpoint\advance\pgf@x by\pgfutil@tempdimd}
  \saveddimen\circlein{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbcirclein}}}
  \saveddimen\circleout{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbcircleout}}}
...
\pgfdeclareshape{pcbacyp} {
  ...
  \beforebackgroundpath{
    ...
    \advance\pgfutil@tempdima by\rcymargin
    \pgfutil@tempdimb=\rcymarks
    \pgf@anchor@pcbacyp@pinmarkb\pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
    \pgf@anchor@pcbacyp@pinmarkb\advance\pgf@x by\pgfutil@tempdimb\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \pgf@anchor@pcbacyp@pinmarka\pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
    \pgf@anchor@pcbacyp@pinmarka\advance\pgf@x by-\pgfutil@tempdimb\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \pgf@anchor@pcbacyp@pinmarka\advance\pgf@x by-0.5\pgfutil@tempdimb\advance\pgf@y by-0.5\pgfutil@tempdimb\pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@y}}
    \pgf@anchor@pcbacyp@pinmarka\advance\pgf@x by-0.5\pgfutil@tempdimb\advance\pgf@y by0.5\pgfutil@tempdimb\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
    \pgfusepath{stroke}
  }
}

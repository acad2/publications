...
\pgfdeclareshape{pcbalf} {
  ...
  \anchor{cinc}{\centerpoint\advance\pgf@x by-\alfhalfwidth\advance\pgf@x by-\alfhalfthick}
  \anchor{cind}{\centerpoint\advance\pgf@x by-\alfhalfwidth\advance\pgf@x by\alfhalfthick}
  \anchor{cine}{\centerpoint\advance\pgf@x by\alfhalfwidth\advance\pgf@x by-\alfhalfthick}
  \anchor{cinf}{\centerpoint\advance\pgf@x by\alfhalfwidth\advance\pgf@x by\alfhalfthick}

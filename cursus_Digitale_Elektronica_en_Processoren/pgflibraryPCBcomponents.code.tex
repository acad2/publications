...
\pgfdeclareshape{pcbacy} {
  ...
  \anchor{labelup}{\pgfutil@tempdimc=\acyhalfthick\centerpoint\advance\pgf@y by\pgfutil@tempdimc}
  \anchor{labeldn}{\pgfutil@tempdimc=\acyhalfthick\centerpoint\advance\pgf@y by-\pgfutil@tempdimc}
  ...
  \anchor{pinmarka}{\pgfutil@tempdimc=\acyhalfwidth\advance\pgfutil@tempdima by\acywire\pgfutil@tempdimd=\circleout\advance\pgfutil@tempdimd by\rcymargin\centerpoint\advance\pgf@x by-\pgfutil@tempdimc\advance\pgf@y by\pgfutil@tempdimd}
  \anchor{pinmarkb}{\pgfutil@tempdimc=\acyhalfwidth\advance\pgfutil@tempdima by\acywire\pgfutil@tempdimd=\circleout\advance\pgfutil@tempdimd by\rcymargin\centerpoint\advance\pgf@x by\pgfutil@tempdimc\advance\pgf@y by\pgfutil@tempdimd}
  \saveddimen\circlein{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbcirclein}}}
  \saveddimen\circleout{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbcircleout}}}
  \saveddimen\rcymargin{\pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/pcbrcyrmargin}}}

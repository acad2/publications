...
\pgfdeclareshape{pcbtact} {
  ...
  \backgroundpath{
    ...
    \centerpoint\advance\pgf@x by-1.5\pgfutil@tempdimc\advance\pgf@y by\pgfutil@tempdimf\advance\pgf@x by-\pgfutil@tempdime\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}\pgfpatharc{90}{270}{\pgfutil@tempdimf and \pgfutil@tempdimf}
    ...
    \tikzset{pcb/part labels} % Use font from this style
    \tikz@textfont
    \centerpoint\advance\pgf@y by-0.5\pgfutil@tempdimd\advance\pgf@y by-\pgfutil@tempdimb

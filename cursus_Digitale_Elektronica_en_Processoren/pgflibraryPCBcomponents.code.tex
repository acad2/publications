...
\pgfdeclareshape{pcbsip} {
  ...
  \backgroundpath{
    ...
    \centerpoint\advance\pgf@x by\pgfutil@tempdimd\advance\pgf@y by-\pgfutil@tempdime\pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}\pgfpatharc{180}{360}{\pgfutil@tempdimd and \pgfutil@tempdimd}\pgfpathclose
    \color{black}
    \pgfusepath{stroke}
    \advance\pgfutil@tempdime by-\pgfutil@tempdimc

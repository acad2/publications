...
\pgfdeclareshape{pcbled} {
  \inheritsavedanchors[from=pcbbase]
  \anchor{pina}{\pgfutil@tempdimc=\ledskew\advance\pgfutil@tempdimc by 0.5\circlediff\centerpoint\advance\pgf@y by\pgfutil@tempdimc}
  \anchor{pinb}{\pgfutil@tempdimc=\ledskew\advance\pgfutil@tempdimc by -0.5\circlediff\centerpoint\advance\pgf@y by\pgfutil@tempdimc}

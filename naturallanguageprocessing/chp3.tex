...
\end{df}
\begin{df}{Agreement}
\sb{} is a concept where for instance a subject and noun must agree in \flv{number} (person). In French nouns and adjectives must also agree in \flv{gender}. One can parse such things my considering this in the design of the \flv{Formal grammar} or by introducing a \flv{Subcategory}.
\end{df}

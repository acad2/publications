...
\sb{} is a finite state model that describes the different rules of morphotactics using a \flv{Finite State Automaton}. Examples of such systems can be found on \imgref{nominalinflection,verbalinflection,adjectivalderivations}.
\end{df}

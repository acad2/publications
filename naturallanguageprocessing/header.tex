...
\newenvironment{tm}[2][]{\renewcommand{\sb}{#2}\renewcommand{\ab}{#1}\ifx&#1&\begin{therm}[#2]\else\begin{therm}[#2 (#1)]\foreach \x in {#1}{\index{\x|see{#2}}}\fi\index{#2|textbf}\label{the:#2}}{\end{therm}}

...
\newcommand{\newchaplet}[2]{\clearpage\lettergroup{#2}\dictchar{#2 #1}\input{#1.texp}}
\newcommand{\newchapleta}[2]{\clearpage\lettergroup{#2}\dictchar{#2}\input{#1.texp}}
\begin{document}
\maketitle
...
\paragraph{}
Personen die extra informatie willen leveren, of bestaande informatie willen corrigeren kunnen mailen naar \href{mailto:belgiancrimedictionary@gmail.com}{belgiancrimedictionary@gmail.com}.

...
\begin{exercise}
Consider the following problem occurring in \concepts{routing application}. Given are n + 1 locations, among which a depot, and distances d between each pair of locations. The depot harbors K vehicles that serve

...
\defgroup[\dma][\dyw-\dywu-\dywb][-0.5*\dylma-3*\dylqma][]{\dywb}{\dylqma}{Optimization problems and Greedy algorithms}{green}{cop}
\defgroup[\dma][\dyw-\dywu][-0.5*\dylma-3*\dylqma][]{\dywu}{\dylqma}{Legend}{backg}{legen}

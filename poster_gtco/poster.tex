...
\defgroup[\dma][0][-0.5*\dylma-4*\dylqma][\includegraphics{compass.pdf}]{\dywr}{\dylqma}{Legend}{backg}{legen}
\defgroup[\dma][\dywr][-0.5*\dylma-4*\dylqma][\includegraphics{palette.pdf}]{2*\dywt-\dywb}{\dylqma}{Graph coloring}{red}{grcl}

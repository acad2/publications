...
\defgroup[\dma][0][-0.5*\dylma-4*\dylqma][\includegraphics{flow.pdf}]{\dywmbt-0.5*\dywr}{\dylqma}{Maximum flow}{purple}{maflw}
\defgroup[\dma][\dywmbt-0.5*\dywr][-0.5*\dylma-4*\dylqma][\includegraphics{palette.pdf}]{\dyw-\dywmbt-0.5*\dywr}{\dylqma}{Graph coloring}{red}{grcl}

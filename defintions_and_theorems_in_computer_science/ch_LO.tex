...
\begin{defi}
D e f i n i t i o n 5. 2 T w o c o m p u t a t i o n paths a r e s i m p l e
v a r i a n t s if they d i f f e r by a d i a m o n d, i. e. they
look like
\cite{conf/ijcai/Geiser75}
\end{defi}

1\begin{defi}
D e f i n i t i o n 6. 1. L e t q1,..., q
denote the o c c u r e n c e s o f s t r o k e s i n the t e r m t.
lng(t) denotes the
set of l i s t e x p r e s s i o n s o b t a i n e d f r o m q1,... q n,
", a n d e x p, a c c o r d i n g to the f o l l o w i n g r u l e s.
1)
2)
\cite{conf/ijcai/Geiser75}
\end{defi}
...
1\begin{defi}
D e f i n i t i o n 6. Z. A m a p p i n g H: I n g ( t ) — * I n g ( s ) is a
h o m o m o r p h i s m (horn) iff f o r a l l ( i, j, f) in Ing(t)
H((ifji,0> = <H(iKH£),f).
Facts about H o m o m o r p h i s m s.
6. 3a If H, G : I n g ( t ) - * I n g ( s ) a r e h o m o m o r p h i s m s
w h i c h a g r e e on I n g Q ( t ) t h e n H = G.
6. 3b A n y m a p H : I n g 0 ( t ) - — * l n g ( 6 ) e x t e n d s to a
unique horn f r o m Ing(t) into Ing(s).
6. 3c H o r n H is 1-1 on I n g ( t ) i f f H is 1-1 on
Ing0(t).
There are infinitely many abstract i n g r e dients in Ing(t) only some of w h i c h r e p r e s e n t r e a l
c o m p u t a t i o n s. W e n o w u s e the i d e a o f h o m o m o r p h i s m t o s i n g l e t h e s e out i n a p r e c i s e m a n n e r.
\cite{conf/ijcai/Geiser75}
\end{defi}

1\begin{defi}
Definition 6. 4. Let P: tl,,..,t be an evalua-
tion path for t; thus ltl = tn. Define the hom
HEP) = H[t1—~z ‘J0 Hitz-:3] 0... °H[tn_1—o tn].
The set of (ILlfmEredients of t w. 1-.t. P is the
set H[P3(I.ngo(tn)) and is denote.l by lng(t;P).
\cite{conf/ijcai/Geiser75}
\end{defi}

1\begin{defi}
Definition 7.2. Let i_and  be ingredients in
\cite{conf/ijcai/Geiser75}
\end{defi}

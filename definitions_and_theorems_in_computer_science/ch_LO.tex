...
% \begin{defi}[Selection function for a set of propositional sentences]
% Definition 4.5 Let E = (K,‘P, <) In my NOP afa belief
% m K. Deﬁne n contrnctian funchon 9 : IF —~ 7-" aver
% I\’ an /alluwss for any F E.7
% \cite{conf/ijcai/ZhangCZC97}
% \end{defi}
% 
% \begin{defi}
% Definition 4.2 [Zhang.l996]Lrt E = (K,’P, <) be an
% NIH’ of a brlmf set K. Define a function  :.7" —~ }',
% rlzllrd NOP rnntr-action over I\', as follows.‘ for any F E
% 7"
% \cite{conf/ijcai/ZhangCZC97}
% \end{defi}

...
\defgroup[\dma][0][-\dylma][\includegraphics{pythia.pdf}]{\dyw}{\dyl}{Orakel (\S3.17)}{orange}{ORAKEL}
\defgroup[\dma][0][-2*\dylma][\includegraphics{turing.pdf}]{\dyw}{\dyl}{Turing (\S3.1-3.9)}{red}{TURING}
\defgroup[\dma][0][-3*\dylma][\includegraphics{chomsky.pdf}]{\dyw}{\dyl}{Context-sensitief (\S2.26)}{purple}{CTXSE}
\defgroup[\dma][0][-4*\dylma][\includegraphics{panini.pdf}]{\dyw}{\dyl}{Context-vrij (\S2.19-\S2.25)}{blue}{CTXFR}
\defgroup[\dma][0][-5*\dylma][\includegraphics{rabin.pdf}]{\dyw}{\dyl}{Regulier (\S2.4-\S2.18)}{green}{REGEX}

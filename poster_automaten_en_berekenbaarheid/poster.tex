...
\defgroup[\dma][0.8*\dyw+\dma][-6*\dylma-5*\dma][\includegraphics{compass.pdf}]{0.2*\dyw-\dma}{\dyl}{Legende}{backg}{LEGEND}
...
\begin{scope}[shift={(LEGEND-LB)},xshift=1.5 cm,yshift=1.5 cm]\innerc[testlang]{TURING}{CTXSE}{CTXFR}{REGEX}{TURING}{CTXSE}\end{scope}
\begin{scope}[shift={(LEGEND-LB)},xshift=5.5 cm,yshift=2.25 cm]\colorlegend{Turing-beslisbaar/red,Context-senstief/purple,Contextvrij/blue,Regulier/green}\end{scope}

\foreach \x/\t in {1/Doorsnede,2/Unie,3/Complement,4/Concatenatie,5/Omkeren,6/Kleene-ster} {
  \draw[<-,thick] (testlang-S\x) -- ++(1.25,0) node[anchor=west]{\t};
}
...
\begin{scope}[xshift=-3 cm,yshift=-0.25 cm]\colorlegend{ja/green,nee/red}\end{scope}

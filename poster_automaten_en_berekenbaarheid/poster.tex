...
\DeclareDocumentCommand{\innerc}{ O{LABEL} O{1.00} O{2.00} m m m}{\findcolor{\cola}{#4}\findcolor{\colb}{#5}\findcolor{\colc}{#6}\computmul[#1][#2][#3]{}{\cola,\colb,\colc}}
...
\CatchFileDef{\tempa}{inner.tex}{}
  \edef\tempb{\unexpanded{\foreach \f/\fa/\fb/\fc in }{\unexpanded\expandafter{\tempa}}}
  \tempb {
  
  \begin{scope}[shift={(\f-C-LB)},xshift=1.5 cm,yshift=1.5 cm]
  \innerc{\fa}{\fb}{\fc}
  \end{scope}

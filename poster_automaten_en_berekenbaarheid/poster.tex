...
\begin{scope}[shift={(LEGEND-LB)},xshift=4 cm,yshift=1.5 cm]\innerc[testlang]{TURING}{CTXSE}{CTXFR}{REGEX}{TURING}{CTXSE}\end{scope}
\begin{scope}[shift={(LEGEND-LB)},xshift=8.5 cm,yshift=2.25 cm]\colorlegend[L2]{Turing-beslisbaar/red,Context-senstief/purple,Contextvrij/blue,Regulier/green}\end{scope}
...
\foreach \x/\t in {1/Doorsnede,2/Unie,6/Kleene-ster} {
  \draw[<-,thick] (testlang-S\x) -- ++(-1.25,0) node[anchor=east]{\t};
}

\groupbox{(testlang-S1) (L2)}{Interne operatie?}
...
\begin{scope}[xshift=-3 cm,yshift=-0.25 cm]\colorlegend[L1]{ja/green,nee/red}\end{scope}

...
\defgroup[\dma][0][-6*\dylma-5*\dma][\begin{tikzpicture}\haskelllogo\end{tikzpicture}]{0.7*\dyw}{\dyl}{Herschrijfsystemen ($\Lambda$-calculus; \S4)}{yellow}{LAMBDA}
\defgroup[\dma][0.7*\dyw+\dma][-6*\dylma-5*\dma][\includegraphics{compass.pdf}]{0.3*\dyw-\dma}{\dyl}{Legende}{backg}{LEGEND}
...
\inputtikzfigure[(TURING-B)][turing-fig][32.25][2][12 cm]{turingmachine}

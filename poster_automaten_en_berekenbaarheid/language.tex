...
\end{itemize}},
redgnfa/REGEX/55/6.2/10 cm/Reductie-stap/Reduce/{Neem een toestand $x\in Q\setminus\accl{q_s,q_f}$ en toestanden $a,b\in Q$ en voer volgende reductie uit:
...
\end{scope}
\end{tikzpicture}},
dfa/REGEX/66/1.2/10 cm/Deterministische eindige toestandsautomaat/DFA/{Een deterministische eindige toestandsautomaat is een $5$-tal $\tupl{Q,\Sigma,\delta,q_s,F}$ waarbij:\begin{itemize}
 \item $Q$ een eindige verzameling toestanden is;
 \item $\Sigma$ een eindig alfabet;

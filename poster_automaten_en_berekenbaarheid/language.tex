...
pac/PROB/8/2.5/14 cm/Acceptatie/$\mbox{\textsc{A}}_{\phi}$/{$A_{\phi}=\accl{\tupl{M,s}|\mbox{$M$ is een $\phi$ die string $s$ accepteert}}$.},
phalt/PROB/23/2.5/14 cm/Stopt/$\mbox{\textsc{H}}_{\phi}$/{$H_{\phi}=\accl{\tupl{M,s}|\mbox{$M$ is een $\phi$ die stopt bij string $s$}}$.},
pe/PROB/38/2.5/14 cm/Leegheid/$\mbox{\textsc{E}}_{\phi}$/{$E_{\phi}=\accl{\tupl{M}|\mbox{$M$ is een $\phi$ die stopt bij string $s$}}$.},
peq/PROB/8/5/14 cm/Gelijkheid/$\mbox{\textsc{EQ}}_{\phi}$/{$EQ_{\phi}=\accl{\tupl{M_1,M_2}|\mbox{$M_1$ en $M_2$ zijn $\phi$'s die dezelfde taal bepalen}}$.},
pes/PROB/23/5/14 cm/Lege string/$\mbox{\textsc{ES}}_{\phi}$/{$ES_{\phi}=\accl{\tupl{M}|\mbox{$M$ bepaalt de lege taal}}$.},
reges/PROB/38/5/14 cm/Regulier/$\mbox{\textsc{Regular}}_{\phi}$/{$ES_{\phi}=\accl{\tupl{M}|\mbox{$M$ bepaalt een reguliere taal}}$.},
alles/PROB/8/7.5/14 cm/Alle strings/$\mbox{\textsc{ALL}}_{\phi}$/{$ES_{\phi}=\accl{\tupl{M}|\mbox{$M$ accepteert alle strings}}$.}
...
feq/REGEX/70.5/1.5/10 cm/{$f$-gelijk}/$f^=$/{Twee toestanden $q_1,q_2\in Q$ in een deterministische eindige toestandsautomaat zijn $f$-gelijk indien:\[\forall w\in\Sigma^{\star}:\fun{\delta^{\star}}{q_1,w}\in F\leftrightarrow\fun{\delta^{\star}}{q_2,w}\in F\]Twee toestanden zijn $f$-verschillend indien ze niet $f$-gelijk zijn.},

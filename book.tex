...
\section*{Exercises}
\begin{exercise}
Prove \colref{tum-graph}, i.e., show that the node-arc incidence matrix of a digraph is TUM, and that the node-edge incidence matrix of a bipartite graph is TUM. Hint: use \thmref{tum-matrix}.
\end{exercise}
\begin{exercise}

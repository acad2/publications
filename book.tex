...
\end{exercise}
\begin{exercise}
A 0-1 matrix has the consecutive ones property if each row has its entries with value 1 in neighboring columns. Such a matrix is also called an interval matrix. Show that such matrices are TUM.
\begin{hint}

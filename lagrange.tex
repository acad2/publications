...
If we wish to use \concept{Lagrangian relaxation} there are different options to consider. Notice that in each of the following four options the relaxed problem LR(λ) is considerably easier to solve than the original
problem.
1
